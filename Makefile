...
clean:
	...
	rm -f tests/server tests/http_get tests/echo tests/resolve_dial tests/close_shutdown tests/timeout tests/ephemeral
	rm -f tests/server.o tests/http_get.o tests/echo.o tests/resolve_dial.o tests/close_shutdown.o tests/timeout.o tests/ephemeral.o
